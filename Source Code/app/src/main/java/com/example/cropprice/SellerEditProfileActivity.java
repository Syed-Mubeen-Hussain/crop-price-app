...
public class SellerEditProfileActivity extends AppCompatActivity {
    ...
    String updateSellerProfile = "https://crop-price-web.000webhostapp.com/seller.php?updateSellerProfile=true";
    String id;
        ...
        btnSellerEditProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.trim().equals("")) {
                    ...
                    SweetAlertDialog pDialog = new SweetAlertDialog(SellerEditProfileActivity.this, SweetAlertDialog.PROGRESS_TYPE);
                    pDialog.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
                    pDialog.setTitleText("Loading");
                    pDialog.setCancelable(false);
                    pDialog.show();
                    StringRequest request = new StringRequest(Request.Method.POST, updateSellerProfile, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            if (response.equals("success")) {
                                ...
                                startActivity(new Intent(SellerEditProfileActivity.this, SellerHomeActivity.class));
                                finish();

                            } else if (response.equals("already")) {
                                Toast.makeText(SellerEditProfileActivity.this, "Email already exist", Toast.LENGTH_LONG).show();
                                pDialog.dismiss();
                            } else {
                                Toast.makeText(SellerEditProfileActivity.this, "Profile Not Update", Toast.LENGTH_LONG).show();
                                pDialog.dismiss();
                            }
                        }
                    ...
                    if (requestQueue == null) {
                        requestQueue = Volley.newRequestQueue(SellerEditProfileActivity.this);
